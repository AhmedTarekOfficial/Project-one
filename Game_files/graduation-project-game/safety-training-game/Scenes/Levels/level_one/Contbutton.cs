...
public partial class Contbutton : Area2D
{
	[Export] private TextureRect Image;
	[Export] private string NextScenePath = "res://Scenes/Levels/level_one/MachinesDistruction.tscn"; // Example: "res://Scenes/MainMenu.tscn"
