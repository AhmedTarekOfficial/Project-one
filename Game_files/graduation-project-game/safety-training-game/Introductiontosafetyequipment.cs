...
public partial class Introductiontosafetyequipment : Node2D
{
	...
	{
		// Get node references
		textLabel = GetNode<RichTextLabel>("shoez_instruction");
		glowImage = GetNode<TextureRect>("Area2D/TextureRect");
